...
public class Demo : MonoBehaviour 
{
    ...
    string m_Tweet = "Alex is doing this shit also subscribe to pewdiepie";
    ...
    void OnGUI()
    {
        ...
        {
            string text = "You need to register your Twitter first. Click this button.(Tab)";
        ...
        else
        {
            ...
            {
                text = "You need to register your Twitter first. Click this button.(Tab)";
            }
    ...
    void LoadTwitterUserInfo()
    {
        ...
        m_AccessTokenResponse.UserId        = null; //PlayerPrefs.GetString(PLAYER_PREFS_TWITTER_USER_ID);
        m_AccessTokenResponse.ScreenName    = null; //PlayerPrefs.GetString(PLAYER_PREFS_TWITTER_USER_SCREEN_NAME);
        m_AccessTokenResponse.Token         = null; //PlayerPrefs.GetString(PLAYER_PREFS_TWITTER_USER_TOKEN);
        m_AccessTokenResponse.TokenSecret   = null; //PlayerPrefs.GetString(PLAYER_PREFS_TWITTER_USER_TOKEN_SECRET);
    ...
    void OnPostTweet(bool success)
    {
        if (success)
        {
            OpeningTwitterDoor.opening = true;
            Debug.Log("Succeeded");
            Debug.Log(OpeningTwitterDoor.opening);
        }
        else
        {
            Debug.Log("failed");
